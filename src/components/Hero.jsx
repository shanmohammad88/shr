...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16 overflow-hidden bg-gradient-to-b from-white via-slate-50 to-slate-100">
      {/* Premium animated background gradient */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 md:w-1/3 h-full bg-gradient-to-l from-indigo-50 to-transparent -z-10 hidden lg:block"></div>
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-indigo-400/5 blur-[120px] rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-indigo-300/5 blur-[100px] rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
      </div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 lg:gap-12 items-center">
          
          {/* Left Side: Content Focused on Freelance Expertise */}
          <div className="lg:col-span-7 z-10 py-6 sm:py-8 md:py-12">
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-gradient-to-r from-indigo-50 to-indigo-100/50 border border-indigo-200 mb-6 sm:mb-8 animate-fade-in hover:shadow-[0_0_20px_rgba(99,102,241,0.2)] transition-all">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-slate-900 tracking-tighter leading-tight sm:leading-[0.95] lg:leading-[0.9] mb-6 sm:mb-8 bg-gradient-to-r from-slate-900 via-indigo-800 to-slate-700 bg-clip-text text-transparent">
              Strategic <br className="hidden sm:block" />
              <span className="text-indigo-600">Human Capital</span> <br className="sm:hidden" /> Advisor.
            </h1>

            <p className="max-w-xl text-base sm:text-lg md:text-xl text-slate-600 mb-8 sm:mb-10 leading-relaxed font-medium">
            ...
            {/* Premium CTAs */}
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 md:gap-5 mb-12 sm:mb-16">
            ...
            {/* High-End Trust Bar */}
            <div className="flex flex-wrap items-center gap-6 sm:gap-8 md:gap-10 pt-8 sm:pt-10 border-t border-slate-200">
          ...
          {/* Right Side: The "Editorial" Image Frame */}
          <div className="lg:col-span-5 relative h-[500px] sm:h-[600px] md:h-[700px] lg:h-auto"
          ...
          >
            <div className={`relative z-10 w-full h-full lg:h-auto lg:aspect-[4/5] rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden shadow-[0_20px_60px_-10px_rgba(0,0,0,0.2)] sm:shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] lg:shadow-[0_50px_120px_-30px_rgba(99,102,241,0.3)] border-8 sm:border-12 lg:border-[16px] border-white ring-1 ring-slate-200 transition-all ${
              imageHovered ? 'ring-indigo-300 shadow-[0_50px_120px_-30px_rgba(99,102,241,0.4)]' : ''
            }`}>
              <img 
                src={shrutiImg} 
            ...
            <div className={`absolute -bottom-6 -right-4 sm:-bottom-8 sm:-right-6 lg:-bottom-10 lg:-right-6 bg-white/95 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl border border-slate-100 z-20 max-w-[160px] sm:max-w-[200px] animate-bounce-slow backdrop-blur-sm hover:shadow-[0_15px_40px_rgba(99,102,241,0.2)] transition-all ${
              imageHovered ? 'animate-none translate-y-2' : ''
            }`}>
            ...
            <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-r from-indigo-100/30 via-indigo-50/20 to-transparent blur-[120px] rounded-full -z-20 transition-opacity ${
              imageHovered ? 'opacity-100' : 'opacity-70'
            }`}></div>
          </div>
